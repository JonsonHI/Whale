...
export default class Search extends React.Component {
            ...
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                <View style={{ position: 'absolute', top: 64, }}>
                    ...
                    {Search.searchText ?
                        ...
                        :
                       this.sourceDataRes(sourceData, sectionIDs, rowIdentifiers)
    ...
    pushToResultPage(keyword) {
         const {Search, dispatch} = this.props;
       delete Search.keywordsList[keyword];  
    ...
    sourceDataRes(sourceData, sectionIDs, rowIdentifiers){
        return(
             <ListView
                            ...
                            keywords.map((keyword) => {
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        activeOpacity={0.75}
                                        onPress={this.pushToResultPage.bind(rowID)}
                                        >
                        ...
                        keywords.map((keyword) => {
                            return (
                                <TouchableOpacity
                                    ...
                                    >
                                    <View style={styles.keywords}>
                                    <Image source={require("../image/close.png")} style={styles.sectionHeaderCleanImg1}/>
                                        <Text style={styles.fonts}>{keyword}</Text>
                                    </View>
