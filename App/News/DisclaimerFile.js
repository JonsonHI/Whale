...
class DisclaimerFile extends  React.Component {
    render () {
        return (
            <View style={styles.container}>
                {/*NavigationBar*/}
                <NavigatorBar title='基酒认证管理细则'  widthWH={Platform.OS == 'ios' ? 15:15} leftBtnName = 'back' rightBtnName = 'Share_icon' leftpress={()=>this.leftAction()} rightPress={()=>this.rightAction()}  />
                <View>
                    <Text style={{height:Height-100,margin:10,borderWidth:1}}>本网站所提供的信息，只供参考之用。
                        ...
                        凡以任何方式登陆本网站或直接、间接使用本网站资料者，视为自愿接受本网站声明的约束。</Text>
                </View>
